...
\begin{center}
  ...
  \normalsize
  \begin{tabular}{|>{\centering\arraybackslash}p{3.2cm}|>{\centering\arraybackslash}p{3.2cm}|>{\centering\arraybackslash}p{3.2cm}|>{\centering\arraybackslash}p{3.2cm}|>{\centering\arraybackslash}p{2.2cm}|}
    \hline
    \rowcolor{exolight}
    \textbf{Exercice 1} & \textbf{Exercice 2} & \textbf{Exercice 3} & \textbf{Exercice 4} & \textbf{Total}\\
    \hline
    \textit{Vocabulaire} & \textit{Arbre à compléter} & \textit{Construction d'arbre} & \textit{Tableau} & \\
    \hline
    /4 pts & /4 pts & /6 pts & /6 pts & \textbf{/20 pts}\\
    \hline
    \rule{0pt}{12mm} & & & & \\
    \hline
  \end{tabular}
